...
class TestSnapshotEvaluation(unittest.TestCase):
    ...
    def test_evaluate_snapshot_model_runs_with_post_hoc_calibration_enabled(self) -> None:
        with tempfile.TemporaryDirectory() as tmp_dir:
            with mock.patch.dict(
                os.environ,
                {
            ...
            config["snapshot"]["enabled"] = True
            config["snapshot"]["directory"] = tmp_dir
            config["snapshot"]["root_name"] = "snapshot_eval_posthoc"
            config["snapshot"]["name"] = "auto"
            config["snapshot"]["on_config_mismatch"] = "create_new"
            config["snapshot"]["max_snapshots"] = 0
            ...
            config["evaluation"]["calibration_analysis"]["enabled"] = False
            config["evaluation"]["post_hoc_calibration"]["enabled"] = True
            config["evaluation"]["post_hoc_calibration"]["method"] = "temperature_scaling"
            config["evaluation"]["post_hoc_calibration"]["fit_on_validation"] = True
            config["evaluation"]["post_hoc_calibration"]["min_samples"] = 1
            config["evaluation"]["post_hoc_calibration"]["temperature_bounds"]["min"] = 0.5
            config["evaluation"]["post_hoc_calibration"]["temperature_bounds"]["max"] = 2.0
